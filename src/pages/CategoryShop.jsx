...
const CategoryShop = () => {
  ...
  return (
    <div>
      <Headers />
      <section className="bg-cover bg-no-repeat h-[220px] mt-6 relative bg-left" style={{ backgroundImage: "url('http://localhost:3000/images/banner/card.jpg')" }}>
        ...
        <div className="w-[85%] md:w-[90%] sm:w-[90%] lg:w-[90%] h-full mx-auto">
          <div className={`md:block hidden ${!filter ? "mb-6" : "mb-0"}`}>
            <button
              ...
              className="text-center w-full py-2 px-3 bg-orange-600 text-white"
            >
              Filtrar Produtos
            </button>
          </div>
            ...
            >
              <div className="py-2 flex flex-col gap-5">
                ...
                <Range
                  ...
                  renderThumb={({ props }) => (
                    <div
                      className="w-[15px] h-[15px] bg-orange-600 rounded-full"
                      {...props}
                    />
                  )}
                />
              ...
              <div className="py-3 flex flex-col gap-4">
                ...
                <div className="flex flex-col gap-3">
                  <div
                    ...
                    className="text-orange-600 flex justify-start items-start gap-2 text-xl cursor-pointer"
                  >
                    <span>
                      <AiFillStar />
                    </span>
                  ...
                  <div onClick={resetRating} className="text-orange-600 flex justify-start items-start gap-2 text-xl cursor-pointer">
                    <span>
                      <CiStar />
                    </span>
                    <span>
