  ...
  return (
    <div>
      ...
      <section
        ...
        style={{ backgroundImage: "url('/public/images/banner/card.jpg')" }}
      >
      ...
      <section className="bg-[#eeeeee]">
        <div className="w-[85%] lg:w-[90%] md:w-[90%] sm:w-[90] mx-auto py-16">
          {card_products.length > 0 || outofstock_products.length > 0 ? (
                  ...
                  <div className="flex flex-col gap-3">
                    <div className="bg-white p-4">
                      <h2 className="text-md text-green-500 font-semibold">
                        Produtos em Estoque: {card_products.length}
                      </h2>
                    </div>
                    ...
                    <div className="bg-white p-3 text-slate-600 flex flex-col gap-3">
                      ...
                      <div className="flex justify-between items-center">
                        ...
                        <span className="text-lg text-orange-600">
                          R$ {price + shipping_fee}
                        </span>
                      </div>
                      <button
                        onClick={redirect}
                        className="px-5 py-[6px] rounded-sm hover:shadow-orange-500/20 hover:shadow-lg bg-orange-600 text-sm text-white uppercase"
                      >
                        Ir para o checkout {buy_product_item}
                      </button>
                    </div>
                  )}
                </div>
            ...
            <div>
              <Link className="px-4 py-1 bg-orange-600 text-white" to="/shops">
                Comprar agora
              </Link>
            </div>
          )}
